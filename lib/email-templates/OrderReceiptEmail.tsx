...
export default function OrderReceiptEmail({ 
  ...
  const content = {
    fa: {
      ...
      nextStepsText: 'سفارش شما در حال پردازش است و به زودی ارسال خواهد شد. ایمیل تأیید ارسال را دریافت خواهید کرد.',
    ...
    en: {
      ...
      nextStepsText: 'Your order is being processed and will be shipped soon. You will receive a shipping confirmation email.',
            ...
            <td style={{ padding: '40px' }}>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  <strong>{t.orderNumber}: {orderId}</strong>
                </p>
              </div>
                  ...
                  {items.map((item, index) => (
                    <tr key={index} style={{ borderBottom: index < items.length - 1 ? '1px solid #f3f4f6' : 'none' }}>
                      ...
                      <td style={{
                        ...
                        {formatPrice(item.unitPriceToman * item.quantity)} {t.currency}
                      </td>
                    </tr>
                  ))}
                  {/* Total Row */}
