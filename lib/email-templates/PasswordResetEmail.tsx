...
export default function PasswordResetEmail({ userName, resetUrl, locale }: PasswordResetEmailProps) {
  ...
  const content = {
    ...
    en: {
      ...
      intro: 'We received a request to reset your password for your Kiara Kraft account.',
