...
async function main() {
  ...
  const productData = [
    ...
    },
    {
      ...
      description:
        'گلدان زیبای سرامیکی با نقوش کلاسیک، ساخت استادکاران لاله‌جین همدان. مناسب برای گل‌های طبیعی و مصنوعی.',
      priceToman: 520000,
      stock: 8,
      categoryId: categories[0].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'بشقاب تزیینی با رنگ فیروزه‌ای و نقوش اسلیمی. کار دست هنرمندان کاشان.',
      priceToman: 295000,
      stock: 20,
      categoryId: categories[0].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'آبخوری سرامیکی با قابلیت خنک نگه‌داشتن آب. ساخت سنتی با طرح‌های ایرانی.',
      priceToman: 680000,
      stock: 6,
      categoryId: categories[0].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'مجموعه کاشی‌های تزیینی با نقوش اسلیمی برای دکوراسیون دیوار. هر بسته شامل 6 عدد کاشی.',
      priceToman: 850000,
      stock: 10,
      categoryId: categories[0].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'مجموعه 3 عددی کاسه سرامیکی در اندازه‌های مختلف. مناسب برای سرو میوه، آجیل و شیرینی.',
      priceToman: 750000,
      stock: 7,
      categoryId: categories[0].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'راهرو فرش دستباف تبریز با طرح شاه عباسی. ابعاد 80×200 سانتی‌متر، مناسب برای راهرو و پذیرایی.',
      priceToman: 5500000,
      stock: 1,
      categoryId: categories[1].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'روسری ابریشمی با بافت ترمه سنتی یزد. نقوش طلایی روی زمینه سرمه‌ای.',
      priceToman: 950000,
      stock: 12,
      categoryId: categories[1].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'رومیزی پنبه‌ای با طرح قلمکار دست‌چاپ اصفهان. مناسب برای میز 6 نفره.',
      priceToman: 480000,
      stock: 8,
      categoryId: categories[1].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'کیف دستی ساخته شده از نمد طبیعی با طرح‌های عشایری. مناسب برای استفاده روزانه.',
      priceToman: 350000,
      stock: 15,
      categoryId: categories[1].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'شال کشمیری نرم با طرح سنتی بته‌جقه. مناسب برای مناسبات خاص و هدیه.',
      priceToman: 2250000,
      stock: 4,
      categoryId: categories[1].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'آویز نقره‌ای با خوشنویسی شعر حافظ. کار دست استاد خوشنویس اصفهانی.',
      priceToman: 680000,
      stock: 10,
      categoryId: categories[2].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'دستبند زنانه نقره با مهره‌های مرجان طبیعی. طراحی مدرن با الهام از نقوش سنتی.',
      priceToman: 920000,
      stock: 7,
      categoryId: categories[2].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'گوشواره زیبا با کار مینا‌کاری سنتی اصفهان. نقوش گل و مرغ روی زمینه آبی.',
      priceToman: 750000,
      stock: 12,
      categoryId: categories[2].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'تسبیح 33 دانه‌ای از کهربای اصل بالتیک. مناسب برای استفاده شخصی و هدیه.',
      priceToman: 1450000,
      stock: 3,
      categoryId: categories[2].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'پابند نقره با آویزهای ظریف و صدای دلنشین. طراحی سنتی مناطق جنوبی ایران.',
      priceToman: 580000,
      stock: 9,
      categoryId: categories[2].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'دکمه سردست مردانه با سنگ لاجورد طبیعی در قاب طلای سفید. مناسب برای مناسبات رسمی.',
      priceToman: 1850000,
      stock: 4,
      categoryId: categories[2].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'صفحه شطرنج لوکس با کار معرق‌کاری چوب گردو و افرا. شامل مهره‌های چوبی دست‌تراش.',
      priceToman: 2800000,
      stock: 2,
      categoryId: categories[3].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'تخته نرد دست‌ساز از چوب سرو با نقش‌برجسته. شامل مهره و تاس عاج مصنوعی.',
      priceToman: 1650000,
      stock: 4,
      categoryId: categories[3].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'قاب عکس زیبا با کار خاتم‌کاری ظریف. مناسب برای عکس‌های 15×20 سانتی‌متر.',
      priceToman: 485000,
      stock: 12,
      categoryId: categories[3].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'ادویه‌دان 7 قسمتی از چوب توت با درب محکم. مناسب برای نگهداری ادویه‌جات.',
      priceToman: 380000,
      stock: 15,
      categoryId: categories[3].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'قاب آینه دست‌تراش با نقوش اسلیمی. چوب گردو و کار دست استادان اصفهانی.',
      priceToman: 1250000,
      stock: 3,
      categoryId: categories[3].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'سینی بزرگ از چوب افرا با دسته‌های مسی. مناسب برای سرو چای و قهوه.',
      priceToman: 650000,
      stock: 8,
      categoryId: categories[3].id,
      sellerId: sellerProfile.id,
    ...
    // PAINTINGS (8 products)
    {
      ...
      description:
        'نگارگری زیبا با موضوع عاشقان در باغ، اثری از هنرمند نامدار اصفهانی با تکنیک‌های کلاسیک.',
      priceToman: 1800000,
      stock: 2,
    ...
    },
    {
      ...
      description:
        'خوشنویسی زیبای غزل حافظ به خط نستعلیق. کار استاد محمد حسینی، قطع 40×60 سانتی‌متر.',
      priceToman: 1200000,
      stock: 5,
      categoryId: categories[4].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'صفحه تذهیب‌شده قرآن کریم با طلاکاری و رنگ‌آمیزی سنتی. کار دست استاد تذهیب.',
      priceToman: 2500000,
      stock: 1,
      categoryId: categories[4].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'نقاشی آبرنگ از باغ ایرانی سنتی با آب‌نما و کاج‌ها. اثر هنرمند معاصر.',
      priceToman: 950000,
      stock: 8,
      categoryId: categories[4].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'نقاشی رنگ روغن از پل خواجو اصفهان در آب‌وهوای غروب. قطع 50×70 سانتی‌متر.',
      priceToman: 1650000,
      stock: 3,
      categoryId: categories[4].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'خوشنویسی مدرن کلمه عشق با ترکیب خط کوفی و نستعلیق. طراحی منحصر به فرد.',
      priceToman: 780000,
      stock: 10,
      categoryId: categories[4].id,
      sellerId: sellerProfile.id,
    ...
    },
    {
      ...
      description:
        'نقاشی رنگ آکریلیک از صحنه قهوه‌خانه سنتی با نقال و سازهای محلی.',
      priceToman: 1350000,
      stock: 2,
      categoryId: categories[4].id,
      sellerId: sellerProfile.id,
  ...
  console.log(
    `   - 8 products per category (ceramics, textiles, jewelry, woodwork, paintings)`
  );
  ...
  return {
    ...
    message:
      'Production database seeded with 40 authentic Iranian handcraft products',
  };
}
