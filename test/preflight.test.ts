...
function testCollectPreflightIssues() {
  const issues = collectPreflightIssues([
    { productId: 'p1', quantity: 3, product: { title: 'A', stock: 2, active: true } },
    { productId: 'p2', quantity: 1, product: { title: 'B', stock: 10, active: false } },
    { productId: 'p3', quantity: 1, product: { title: 'C', stock: 5, active: true } },
  ]);
